...
# 2.1.6 (Released)
## Updates:
- Fixed a bug where when a player used /tpa to playername, the target player prompt would display "own name" request transmitted
## 更新:
- 修复了当玩家使用/tpa to playername时，目标玩家提示词将显示“自己名字”请求传送过来的Bug
